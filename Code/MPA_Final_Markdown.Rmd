...
nrow(filter(MPA.data, Year.Established == 0)) #60 observations have no date found

unique(MPA.data$Year.Established)
...
Clean.plot <- 
  ...
  scale_x_date(date_break = "1 years", date_labels = "%Y", limits = as.Date(c('2000-11-15','2023-11-15')) ) +
  labs(x = "Year", y = "Count") +
...
p2 <- 
  ...
  labs(x = "Level of Protection", y = "Count") 
print(p2)
...
p3 <- 
  ...
  labs(x = "Management.Plan", y = "Count") + 
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))
print(p3)
