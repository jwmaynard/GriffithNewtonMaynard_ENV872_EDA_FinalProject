...
Understanding and visualizing the growth of MPAs in the United States over time is a critical piece in acheiving the 30x30 goal. The following figures show the cumulative growth over time of the number of MPAs (Figure 2) and the total area of MPAs (Figure 3). 
