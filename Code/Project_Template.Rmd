...
```{r Level of Protection Plots, echo=FALSE, message = FALSE, warning = FALSE, fig.cap='Figure 4: INSERT', fig.width= 7}
...
```{r LoP no Zoned No Take, echo=FALSE, message = FALSE, warning = FALSE, fig.cap='Figure 5: INSERT', fig.width = 7}
...
```{r LoP bar plot, echo=FALSE, fig.cap='Figure 6: INSERT', message=FALSE, warning=FALSE}
...
```{r Management Plan plots, echo=FALSE, message = FALSE, warning = FALSE, fig.cap='Figure 7: INSERT', fig.width=7}
...
```{r MP w/o site specific, echo=FALSE, message = FALSE, warning = FALSE, fig.cap='Figure 8: INSERT', fig.width=7}
...
```{r Management Plan count, echo=FALSE, fig.cap='Figure 9: INSERT', message=FALSE, warning=FALSE}
