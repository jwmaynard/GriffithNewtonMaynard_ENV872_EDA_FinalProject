...
```{r LoP no Zoned No Take, echo=FALSE, message = FALSE, warning = FALSE, fig.cap='Plot showing cumulative area of MPAs over time by Level of Protection with MPAs Zoned with No Take Areas omitted.'}
